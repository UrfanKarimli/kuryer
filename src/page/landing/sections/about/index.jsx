...
const About = () => {
    return (
        <div className='container w-full flex flex-wrap-reverse justify-between items-center  gap-8'>
            <div
                style={{
            ...
            <div className=' w-[460px]'>
                <a href="/">
                    <h3 className='text-[#f1f2f3] text-base font-semibold mb-1 flex items-center gap-1'>Bığlı <span className='text-[#ff764d] flex gap-1 items-center'> Kuryer </span></h3>
                </a>
